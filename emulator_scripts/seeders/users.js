  ...
  for (const [userKey, userDef] of Object.entries(USER_DEFINITIONS)) {
    try {
      ...
      if (!userDoc.exists) {
        ...
        userData.teacherLinks = {
          all: [],
          current: [],
          dates: {},
        };
        userData.parentLinks = {
          all: [],
          current: [],
          dates: {},
        };
        ...
        if (userDef.userType === 'student') {
          userData.birthMonth = 8;
          userData.birthYear = 2013;
        }
